...
DROP TABLE IF EXISTS `applicationtemplate`.`emaillog`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_emaillog_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_emaillog_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_emaillog_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_emaillog_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_emaillog_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_emaillog_Search`;
...
CREATE TABLE `applicationtemplate`.`emaillog` (
Id INT AUTO_INCREMENT,
Email VARCHAR(255),
SentDate DATETIME,
EmailTypeId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_emaillog_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_emaillog_LoadAll`
()
BEGIN
	SELECT
		`emaillog`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_emaillog_Add`
(
	 IN paramEmail VARCHAR(255),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_emaillog_Update`
(
	IN paramId INT,
	IN paramEmail VARCHAR(255),
	IN paramSentDate DATETIME,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_emaillog_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_emaillog_Search`
(
	IN paramId INT,
	IN paramEmail VARCHAR(255),
	IN paramSentDate DATETIME,
