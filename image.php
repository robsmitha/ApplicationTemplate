...
<div class="container">
    ...
    <h1 class="mt-4 mb-3">Image
        <small><a href="event.php?id=<?php echo $image->getEventId(); ?>" class="btn btn-link">View Event</a></small>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            if($securityuserid > 0){
                ...
                <a class="btn btn-outline-danger btn-block" href="create-image.php?id=<?php echo $image->getId(); ?>&cmd=edit">Edit Image</a>
                <form method="post">
                    <button name="btnDelete" class="btn btn-danger btn-block" value="<?php echo $image->getId()?>">Delete</button>
                </form>
                <?php
            }
            ?>
